  ...
  return (
    ...
    >
      <Form method="post">
        ...
        <TextField margin="normal" fullWidth label="Solution" name="solution" />
        <TextField margin="normal" fullWidth label="Description" name="description" multiline rows={4} />
        <TextField margin="normal" fullWidth required label="Reward MC" name="rewardMc" type="number" />
        <TextField margin="normal" required fullWidth label="Reward FC" name="rewardFc" type="number" />
        <TextField
          margin="normal"
          required
          fullWidth
